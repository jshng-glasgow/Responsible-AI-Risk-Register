...
4. Fill in the form, including any tags that apply to the risk.
5. Submit the issue.
...
### 2. Propose an update to an existing risk (GitHub)

To suggest a change to an existing risk:

1. Go to the **Issues** tab.
2. Click **New Issue**.
3. Select **Update an existing risk**.
4. Fill in the form, including the issue number or identifier of the risk you want to update.
5. Submit the issue.
...
### 3. Submit a risk privately or anonymously
...
- [Sangetta Bhatia](https://github.com/sangeetabhatia03)
